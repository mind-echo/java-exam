...
<body>
	...
	<div id="main">
		<div class="container" style="margin-top: 20px;">
			<form name="form1" method="post" action="shortAnswersearchlist">
				<div class="row">
					...
					<tr
						...
						<td>
							<s:if test=" #session['USER_INFO'].role==1">
								<a href=#  onclick='deleteShortAnswer(<s:property value="id"/>)'>删除</a>
							</s:if>
						</td>
					</tr>
				</s:iterator>
	...
	<script>
		...
		function deleteShortAnswer(id){
			if (confirm("确定要删除该简答题吗？")) {
				$.ajax({
