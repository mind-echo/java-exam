...
<div id="main">
	<div style="margin-top: 20px;"><!-- delete class for dialog -->
		<form name="shortAnswersearchform" method="post" action="shortAnswersearchlist1">
			<div class="row">
                   <div class="input-field col l3 m4 s12">
                       ...
                       <input type="text" placeholder="输入题干包含的内容" id="contentSearch" name="contentSearchShortAnswer"
                   ...
                   <div class="input-field col l3 m4 s12">
                       ...
                       <input type="text" placeholder="输入答案中包含的内容" id="answerSearch" name="answerSearchShortAnswer"
                   ...
                   <div class="input-field col l3 m4 s12">
                       ...
                       <input type="text" placeholder="输入知识点" id="knowledgeSearch" name="knowledgeSearchShortAnswer"
		...
		<form name="shortAnswerselectform"  method="post"><!-- add form for dialog -->
		...
		<table class="mytable">
			...
			<s:iterator value="questionList" status="st" var="item">
				<tr
					...
					<td><a class="namelink"
						href="<s:url action="shortAnswerdetail"><s:param name="qid" value="%{id}"></s:param></s:url>"><s:property
								value="content" /></a></td>
					<td>
...
<script>
	function selectPage(page){
		...
		form2.action="searchShortAnswer";
		form2.submit();
	}
		...
		$.post("shortAnswersearchlist1",
				...
				function(data,status){
					...
					for(var i=0; i<data.length; i++){
						showHtml+="<tr style='background:"+(i%2==0?"#efefef":"#ffffff")+";'><td><input type='checkbox' class='with-gap' name='shortAnswerSelect' id='shortAnswerSelect"
						+data[i].id+"' value='"+data[i].id+"'><label for='shortAnswerSelect"+data[i].id+"'>"
						+data[i].id+"</label></td>";
